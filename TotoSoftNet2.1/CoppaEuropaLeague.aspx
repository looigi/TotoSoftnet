<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="TsnII.Master" CodeBehind="CoppaEuropaLeague.aspx.vb" Inherits="TotoSoftNet21.CoppaEuropaLeague" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="contentCentrale" runat="server">
            ...
            <div class="box-content">
                <fieldset>
                    <div class="span7" style="text-align: center;">
                        <img src="App_Themes/Standard/Images/Icone/EuropaLeague.png" width="50" />
                        <asp:Label ID="Label2" runat="server" Text="Europa League" CssClass ="label-titolo"></asp:Label>
                        <img src="App_Themes/Standard/Images/Icone/EuropaLeague.png" width="50" />
                    </div>

                    <div class="span5" style="text-align: right;">
                        <asp:Button ID="cmdTurni" runat="server" Text="Turni" CssClass="btn btn-primary" />
    ...
    <%--				<a href="#" class="btn-close"><i class="halflings-icon white remove"></i></a>--%>
        ...
        <div id="divDettaglio2" runat="server" class="span7" style="">
	        <div class="box-header">
