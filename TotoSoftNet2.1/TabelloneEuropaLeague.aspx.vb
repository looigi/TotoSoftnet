Public Class TabelloneEuropaLeague
    ...
    Private Sub CaricaDati()
        ...
        If Db.LeggeImpostazioniDiBase() = True Then
            ...
            If g > MaxGiornate - 1 Then g = MaxGiornate - 1
            If g < 0 Then g = 0
            ...
            DisegnaTabellone(1, "EuropaLeague", "Europa League", "PartiteEuropaLeagueTurni", divScontriDiretti)
    ...
    Private Sub PrendeQualificate(Db As GestioneDB, ConnSQL As Object)
        ...
        Sql = "Select A.*, B.Giocatore, B.Punti, B.Giocate, B.GFatti, B.GSubiti From EuropaLeagueSquadre A " &
            "Left Join AppoEuropaLeague B On A.Anno=B.Anno And A.CodGiocatore=B.CodGiocatore " &
            "Left Join Giocatori C On A.Anno=C.Anno And A.CodGiocatore=C.CodGiocatore " &
            "Where A.Anno=" & DatiGioco.AnnoAttuale & " And Punti Is Not Null And C.Cancellato='N' " &
        ...
        If StringaIn.Length > 0 Then
            ...
            Sql = "Select A.*, B.Giocatore From EuropaLeagueSquadre A " & _
    ...
    '    Sql = "Select A.*, B.Giocatore As Casa, C.Giocatore As Fuori From PartiteEuropaLeagueTurni A " & _
    '        "Left Join Giocatori B On A.Anno=B.Anno And A.GiocCasa=B.CodGiocatore " & _
    ...
    '            Sql = "Select * From PartiteEuropaLeagueTurni Where Anno=" & DatiGioco.AnnoAttuale & " " & _
    ...
    '                    Sql = "Select GiocCasa From PartiteEuropaLeagueTurni Where Anno=" & DatiGioco.AnnoAttuale & " " & _
    '                        "And GiocFuori=-1"
    '                    Rec2 = Db.LeggeQuery(ConnSql, Sql)
    '                    If Rec2.Eof = False Then
    ...
    Private Sub VisualizzaTurni(Db As GestioneDB, ConnSql As Object, Giornata As Integer)
        ...
        Sql = "Select A.*, B.Giocatore As Casa, C.Giocatore As Fuori From PartiteEuropaLeague A " & _
            "Left Join Giocatori B On A.Anno=B.Anno And A.GiocCasa=B.CodGiocatore " & _
            "Left Join Giocatori C On A.Anno=C.Anno And A.GiocFuori=C.CodGiocatore " & _
    ...
    '        Dim Sql As String = "Select Max(Giornata) From PartiteEuropaLeague Where Anno=" & DatiGioco.AnnoAttuale
    ...
    '        Dim Sql As String = "Select Min(Giornata) From PartiteEuropaLeagueTurni Where Anno=" & DatiGioco.AnnoAttuale
    '        Dim Rec As Object = Server.CreateObject("ADODB.Recordset")
    '        Dim Giornata As Integer
