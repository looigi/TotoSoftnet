...
Public Class ControlloSchedine
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Page.IsPostBack = False Then
            ...
            If Db.LeggeImpostazioniDiBase() = True Then
                ...
                If Not ControllaSemaforo(Db, ConnSQL) Then
                    Ok = False
                End If
            ...
            Else
                grdPartite.Visible = False
                cmdControlla.Visible = False
                divColonna.Visible = False
                lblSpeciale.Text = "Maschera bloccata da altro utente"
            End If
    ...
    Public Function ControllaSemaforo(Db As GestioneDB, ConnSQL As Object) As Boolean
        Dim Sql As String
        Dim Rec As Object = CreateObject("ADODB.Recordset")
        Dim Ritorno As Boolean
        Dim Scrivi As Boolean = False

        Sql = "Select * From SemaforoPerControllo Where Anno=" & DatiGioco.AnnoAttuale & " And Giornata=" & DatiGioco.Giornata & " And CodGiocatore<>" & Session("CodGiocatore")
        Rec = Db.LeggeQuery(ConnSQL, Sql)
        If Rec.Eof = True Then
            Ritorno = True
            Scrivi = True
        Else
            Dim ds As Date = Rec("DataEntrata").Value
            Dim wD As Long = DateDiff(DateInterval.Minute, ds, Now)
            If Math.Abs(wD) < 30 Then
                Scrivi = False
                Ritorno = False
            Else
                Scrivi = True
        ...
        If Scrivi Then
            Dim d As Date = Now
            Dim dd As String = ConverteData(d)

            Sql = "Delete From SemaforoPerControllo Where Anno=" & DatiGioco.AnnoAttuale & " And Giornata=" & DatiGioco.Giornata
            Db.EsegueSql(ConnSQL, Sql)

            Sql = "Insert Into SemaforoPerControllo Values (" & DatiGioco.AnnoAttuale & ", " & DatiGioco.Giornata & ", " & Session("CodGiocatore") & ", '" & dd & "')"
            Db.EsegueSql(ConnSQL, Sql)
        End If
    ...
    Protected Sub cmdControlla_Click(sender As Object, e As EventArgs) Handles cmdControlla.Click
        ...
        If Db.LeggeImpostazioniDiBase() = True Then
                            ...
                            If Giocatori(i) <> "" Then
                                ...
                                Do Until RecI.Eof
                                    ...
                                    If RisultatoUscito = RisultatoGiocato Then
                                        ...
                                        End If
                                    Else
                                        If RisultatoGiocato = "" Then RisultatoGiocato = "99-11"
            ...
            Sql = "Delete From Risultati Where Anno=" & DatiGioco.AnnoAttuale & " And Concorso=" & g
            Db.EsegueSql(ConnSQL, Sql)

            If Speciale = True Then
                Sql = "Delete From ClassificaSpeciale Where idAnno=" & DatiGioco.AnnoAttuale & " And idGiornata=" & g
            End If
            Db.EsegueSql(ConnSQL, Sql)
            ...
            For i As Integer = 0 To QuantiGioc
                If Giocatori(i) <> "" Then
                    ...
                    If Speciale = True Then
                        ...
                        Sql = "Insert Into ClassificaSpeciale Values (" &
                            " " & DatiGioco.AnnoAttuale & ", " &
                            " " & g & ", " &
                            " " & i & ", " &
    ...
    Private Sub MostraRisultati(Giocatori() As String, Pagante() As String, PuntiSegni() As Single, PuntiRisultati() As Single, PuntiJolly() As Single,
                                PuntiQuote() As Single, PuntiFR() As Single, PuntiSomma() As Single, PuntiDifferenza() As Single, Tappato() As Boolean)
        ...
        If Db.LeggeImpostazioniDiBase() = True Then
            ...
            'Sql = "Create Table AppoClassGiornata (Posiz Int, CodGioc Varchar(20), Totale Numeric(8,3), Risultati Numeric(8,3), " &
            ...
            Sql = "Delete From AppoClassGiornata Where Anno=" & DatiGioco.AnnoAttuale & " And Giornata=" & gg
            Db.EsegueSqlSenzaTRY(ConnSQL, Sql)

            For I = 1 To QuantiGioc
                idGioc = g.TornaIdGiocatore(Giocatori(I))

                Sql = "Insert Into AppoClassGiornata Values (" &
                    " " & I & ", " &
                    "'" & Giocatori(I) & "', " &
            ...
            Sql = "Select * From AppoClassGiornata Where Anno=" & DatiGioco.AnnoAttuale & " And Giornata=" & gg & " Order By Tappato, Totale Desc"
            Rec = Db.LeggeQuery(ConnSQL, Sql)
            Do Until Rec.Eof
                PosizioneReale += 1
    ...
    Private Sub MostraVincitoriEUltimi()
        ...
        If Db.LeggeImpostazioniDiBase() = True Then
            ...
            Sql = "Select A.*, B.Giocatore " &
                "From AppoClassGiornata A Left Join Giocatori B On A.Anno=B.Anno And A.idGioc=B.CodGiocatore " &
                "Where A.Anno = " & DatiGioco.AnnoAttuale & " And A.Giornata = " & gg & " " &
                "Order By Tappato, A.Totale Desc, Segni Desc, Risultati Desc, Jolly Desc, Quote Desc, FR Desc, PuntiSomma Desc, PuntiDifferenza Desc"
            Rec = Db.LeggeQuery(ConnSQL, Sql)
            If Rec.Eof = False Then
