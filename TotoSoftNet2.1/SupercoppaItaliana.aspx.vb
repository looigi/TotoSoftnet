Public Class SupercoppaItaliana
    ...
    Private Sub CaricaDati()
        ...
        If Db.LeggeImpostazioniDiBase() = True Then
            ...
            Sql = "Select * From PartiteSuperCoppaItalianaTurni " &
    ...
    Private Sub ControllaVincitore(Db As GestioneDB, ConnSql As Object)
        ...
        Sql = "Select A.GiocCasa, B.Giocatore From PartiteSuperCoppaItalianaTurni A " &
    ...
    Private Sub VisualizzaSquadre(Db As GestioneDB, ConnSql As Object, Giornata As Integer)
        ...
        Sql = "Select A.*, B.Giocatore As Casa, C.Giocatore As Fuori From PartiteSuperCoppaItalianaTurni A " &
        ...
        lblAttuale.Text = "Supercoppa Italiana: Finale secca"
