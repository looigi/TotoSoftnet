    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Page.IsPostBack = False Then
            ...
            If "" & Session("Nick") = "" Or DatiGioco.AnnoAttuale = 0 Then
                If NomePagina.ToUpper.Trim <> "DEFAULT.ASPX" And NomePagina.ToUpper.Trim <> "NUOVOUTENTE.ASPX" And NomePagina.ToUpper.Trim <> "REGOLAMENTOESTERNO.ASPX" Then
            ...
            Select Case NomePagina.ToUpper.Trim
                Case "DEFAULT.ASPX", "NUOVOUTENTE.ASPX"
                    ...
                    idSfondo.Style.Add("background-size", "cover;")
                Case "REGOLAMENTOESTERNO.ASPX"
                    idnavigazione.Visible = False
                    idboxprofilo.Visible = False
                    ImpostaTastiMenu()
                Case Else
