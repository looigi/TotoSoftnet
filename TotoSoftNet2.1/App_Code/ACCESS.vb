Public Class ACCESS
    ...
    '        conn = g.ApreDB()
    '        Dim sql As String = "Select * From Schedine"
    ...
    Public Function LeggeImpostazioniDiBase(PercorsoDB As String) As Boolean
        Dim Ritorno As String
        Dim Ok As Boolean = True

        Dim Provider As String = NomeProvider
        Dim connectionString As String = StringaConnessioneAccess

        Connessione = connectionString.Replace("***", PercorsoDB)
