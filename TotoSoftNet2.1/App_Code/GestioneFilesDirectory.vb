...
Public Class GestioneFilesDirectory
    ...
    Public Function EliminaFileFisico(NomeFileOrigine As String) As String
        ...
        If NomeFileOrigine.Trim <> "" Then
            Try
                My.Computer.FileSystem.DeleteFile (NomeFileOrigine)
    ...
    Public Sub CreaAggiornaFile(NomeFile As String, Cosa As String)
        ...
        Catch ex As Exception
            ...
            'StringaPassaggio = "?Errore=Errore CreaAggiornaFile : " & Err.Description.Replace(" ", "%20").Replace(vbCrLf, "")
    ...
    Public Function Ordina(Filetti() As String, Quanti As Long) As String()
        ...
        For i As Integer = 1 To Quanti
            For k As Integer = i + 1 To Quanti
    ...
    Public Sub EliminaAlberoDirectory(Percorso As String, EliminaRoot As Boolean, EliminaFiles As Boolean)
        ...
        DirectoryRilevate = Ordina(DirectoryRilevate, QuanteDirRilevate)

        If EliminaFiles = True Then
            FilesRilevati = Ordina(FilesRilevati, QuantiFilesRilevati)

            For i As Integer = QuantiFilesRilevati - 1 To 1 Step -1
                Try
        ...
        For i As Integer = QuanteDirRilevate - 1 To 1 Step -1
            Try
