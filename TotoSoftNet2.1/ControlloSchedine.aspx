<%@ Page Title="" Language="vb" EnableEventValidation="true" AutoEventWireup="false" MasterPageFile="TsnIISM.Master" CodeBehind="ControlloSchedine.aspx.vb" MaintainScrollPositionOnPostBack = "true" Inherits="TotoSoftNet21.ControlloSchedine" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphNoAjax" runat="server">
    <%--<div class="row-fluid">--%>
        ...
        <div class="box span6" id="divRisultati" runat="server" style="margin-left: 2px;" >
