<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="TsnII.Master" CodeBehind="SupercoppaEuropea.aspx.vb" MaintainScrollPositionOnPostBack = "true" Inherits="TotoSoftNet21.SupercoppaEuropea" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="contentMenuNavigazione" runat="server">
    <ul class="breadcrumb">
		...
		<li><i class="icon-glass"></i><a href="#">Supercoppa Europea</a></li>
	</ul>
</asp:Content>
            ...
            <div class="box-content">
                <fieldset>
                    <div class="span12" style="text-align: center;">
                        <img src="App_Themes/Standard/Images/Icone/SupercoppaEuropea.png" width="50" />
    ...
    <div id="divDettaglio" runat="server" class="row-fluid sortable ui-sortable">				
        <div class="box span12">
	        <div class="box-header">
			    <h2><i class="halflings-icon white align-justify"></i><span class="break"></span>Supercoppa Europea</h2>
			    <div class="box-icon">
